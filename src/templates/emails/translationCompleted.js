...
export const translationCompletedTemplate = ({ filename, targetLangName, downloadUrl, translationUrl }) => baseEmailTemplate({
  title: 'Translation completed ✅',
  subtitle: `Your file "${filename}" is ready in ${targetLangName}.`,
  body: `
    <p>Hi there,</p>
    <p>Your file <strong>${filename}</strong> has been successfully translated to <strong>${targetLangName}</strong>.</p>
